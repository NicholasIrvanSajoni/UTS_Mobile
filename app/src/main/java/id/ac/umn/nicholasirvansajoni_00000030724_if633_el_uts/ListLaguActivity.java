...
public class ListLaguActivity extends AppCompatActivity implements
        id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Recycler_Song_Touch.RecycleSongTouchHelperListener, id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Adapter_Lagu.SongAdapterListener,
    ...
    private List<id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu> mSongList = new ArrayList<>();
    private RecyclerView mRecyclerViewSongs;
    private id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Adapter_Lagu mAdapter;
    ...
    private id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Timer timeUtil;
...
//        getMenuInflater().inflate(R.menu.menu_main, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId()==R.id.profil){
            startActivity(new Intent(this, id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.ListKeProfilActivity.class));
        } else if (item.getItemId() == R.id.logout) {
            startActivity(new Intent(this, id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.MainActivity.class));
            mMediaPlayer.stop();
            mMediaPlayer.release();
            mMediaPlayer = null;
        }else {
//            Log.d(this.getClass().getName(), "Option selected");
    ...
    private void init(){
        ...
        timeUtil = new id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Timer();
    ...
    private void setUpAdapter(){
        mAdapter = new id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Adapter_Lagu(getApplicationContext(), mSongList, this);
    ...
    private void setUpListeners(){
        ItemTouchHelper.SimpleCallback itemTouchHelperCallback =
                new id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Recycler_Song_Touch(0, ItemTouchHelper.LEFT, this);
    ...
    private void getSongList(){
        ...
        if (musicCursor != null && musicCursor.moveToFirst()) {
            ...
            do {
                ...
                mSongList.add(new id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu(thisId, thisTitle, thisArtist, uri.toString(),
        ...
        Collections.sort(mSongList, new Comparator<id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu>() {
            public int compare(id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu a, id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu b) {
    ...
    private void welcomeMessage(){
        // TODO pop up menu
        dialog = new AlertDialog.Builder(id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.ListLaguActivity.this);
...
//        });
    ...
    private boolean checkStorePermission(int permission) {
        if (permission == STORAGE_PERMISSION_ID) {
            return id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Permission.checkPermissions(this,
    ...
    private void showRequestPermission(int requestCode) {
        ...
        id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Permission.requestPermissions(this, requestCode, permissions);
    }
    ...
    public void onSwiped(RecyclerView.ViewHolder viewHolder, int direction, int position) {
        if (viewHolder instanceof id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Adapter_Lagu.MyViewHolder) {
            // get the removed item name to display it in snack bar
            String name = mSongList.get(viewHolder.getAdapterPosition()).getTitle();
            // backup of removed item for undo purpose
            final id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu deletedItem = mSongList.get(viewHolder.getAdapterPosition());
...
//            deleteMusic(file);
    ...
    @Override
    public void onSongSelected(id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu lagu) {
        playSong(lagu);
        currentSongIndex = mSongList.indexOf(lagu);
...
//        startActivity(nowPlayingIntent);
    ...
    public boolean deleteMusic(final File file) {
        ...
        final ContentResolver contentResolver = id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.ListLaguActivity.this.getContentResolver();
    ...
    @SuppressLint("UseCompatLoadingForDrawables")
    public void playSong(id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu lagu) {
        try {
            mMediaPlayer.reset();
//            mMediaPlayer.setAudioStreamType(AudioManager.STREAM_MUSIC);
            mMediaPlayer.setDataSource(lagu.getSongLink());
            Log.d(null, lagu.getSongLink());
            ...
            mTvTitle.setText(lagu.getTitle());
            Glide.with(this).load(lagu.getThumbnail()).placeholder(R.drawable.ikonmusik).error(R.drawable.ikonmusik)
    ...
    private void playNextSong() {
        if (currentSongIndex < (mSongList.size() - 1)) {
            id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu lagu = mSongList.get(currentSongIndex + 1);
            playSong(lagu);
    ...
    private void playPreviousSong() {
        if (currentSongIndex > 0) {
            ...
            id.ac.umn.nicholasirvansajoni_00000030724_if633_el_uts.Lagu lagu = mSongList.get(mSongList.size() - 1);
            playSong(lagu);
